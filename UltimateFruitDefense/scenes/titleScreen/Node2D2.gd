...
onready var start = get_node("/root/Node2D/Node2D2/startStaticBody2D/start")
onready var before_start = get_node("/root/Node2D/Node2D2/before we start")
onready var my_name = get_node("/root/Node2D/Node2D2/my name is")
onready var im_a = get_node("/root/Node2D/Node2D2/i am a")
