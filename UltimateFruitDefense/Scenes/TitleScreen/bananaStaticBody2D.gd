...
var base_text = preload("res://Assets/Sprites/TitleScreen/Texts/English/Load game.png")
var hover_text = preload("res://Assets/Sprites/TitleScreen/Texts/English/Load game(v2).png")
