...
var base_text = preload("res://Assets/Sprites/TitleScreen/Texts/English/Instructions.png")
var hover_text = preload("res://Assets/Sprites/TitleScreen/Texts/English/Instructions(v2).png")
